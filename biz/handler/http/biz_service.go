// Code generated by hertz generator.
	...
	func BizMethod1(ctx context.Context, c *app.RequestContext) {
		...
		resp, err := DoBizMethod1(ctx, cli, string(st)) // Pass the generic client and requestContext
		if err != nil {
	...
	func BizMethod2(ctx context.Context, c *app.RequestContext) {
		...
		resp, err := DoBizMethod2(ctx, cli, string(st)) // Pass the generic client and requestContext
		if err != nil {
			c.String(consts.StatusInternalServerError, "Failed to perform generic call")
			return
		}
	...
	func BizMethod3(ctx context.Context, c *app.RequestContext) {
		...
		resp, err := DoBizMethod3(ctx, cli, string(st)) // Pass the generic client and requestContext
		if err != nil {
			c.String(consts.StatusInternalServerError, "Failed to perform generic call")
			return
		}
	...
	var myGenClientPool = sync.Pool{
		New: func() interface{} {
			...
			return BizServiceGenericClient()
		},
	}