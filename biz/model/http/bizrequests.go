...
type BizRequest struct {
	Vint64  int64    `thrift:"vint64,1" form:"vint64" json:"vint64" query:"vint64"`
	Text    string   `thrift:"text,2" form:"text" json:"text" query:"text"`
	Token   int32    `thrift:"token,3" form:"token" json:"token" query:"token"`
	Items   []string `thrift:"items,6" form:"items" json:"items" query:"items"`
	Version int32    `thrift:"version,7" form:"version" json:"version" query:"version"`
}
